...
public class ShowHobbyActivity2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initHobbies();
        HobbyAdapter hobbyAdapter=new HobbyAdapter(ShowHobbyActivity2.this,R.layout.showhobby_item,hobbyList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent=new Intent(ShowHobbyActivity2.this,HobbyInfoActivity.class);
    ...
    private void initHobbies() {
        MyDBHelper dbHelper= MyDBHelper.getMyDBHelper(ShowHobbyActivity2.this,"goodhobby.db",null,1);
        ...
        if(cursor.moveToFirst()){
            ...
            AlertDialog.Builder dialog=new AlertDialog.Builder(ShowHobbyActivity2.this);
            dialog.setTitle("Monkey is here");
            dialog.setMessage("你还没有已完成的习惯呢");
            dialog.show();
