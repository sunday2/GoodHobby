...
public class ShowHobbyActivity3 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initHobbies();
        HobbyAdapter hobbyAdapter=new HobbyAdapter(ShowHobbyActivity3.this,R.layout.showhobby_item,hobbyList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent=new Intent(ShowHobbyActivity3.this,HobbyInfoActivity.class);
    ...
    private void initHobbies() {
        MyDBHelper dbHelper= MyDBHelper.getMyDBHelper(ShowHobbyActivity3.this,"goodhobby.db",null,1);
        SQLiteDatabase db=dbHelper.getWritableDatabase();
        Cursor cursor=db.rawQuery("select * from TBL_HOBBY where grade!=?",new String []{"4"});
        if(cursor.moveToFirst()){
            ...
            AlertDialog.Builder dialog=new AlertDialog.Builder(ShowHobbyActivity3.this);
